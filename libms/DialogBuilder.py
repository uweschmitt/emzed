...
class DialogBuilder(object):
    ...
    def show(self):
        ...
        return tuple(getattr(instance, name) for name in self.fieldNames)
...
if __name__ == "__main__":
    ...
    print DialogBuilder("Test")\
            .addFloat("Float #1", min=0.0, help="float input, min=0")\
            .addInt("Int #2", min=-3, help="int input, min=-3")\
            .addString("String #3", default="input string")\
            .addText("Text #4", default="input text")\
            .addBool("Bool #5", default=True)\
            .addChoice("Choice #6", ["one", "two"], default=1)\
            .addMultipleChoice("Choice #7", ["a", "b"], default=[1])\
            .addFileOpen("Open File")\
            .addFilesOpen("Open Files")\
            .addFileSave("Save Files")\
            .addDirectory("Directory")\
            .addButton("Run Script", scriptOne)\
            .show()
