#encoding: latin-1
## start of http://code.activestate.com/recipes/523004/ }}}
import gc, sys
from types import FrameType

def print_cycles(objects=gc.garbage, outstream=sys.stdout, show_progress=False):
    """
    ...
    for obj in objects:
        ...
        recurse(obj, obj, { }, [])
## end of http://code.activestate.com/recipes/523004/ }}}
